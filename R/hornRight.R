h3rlongShort <- function(xStart, yStart, headingStart = 45, method = "bezier"){
...
h3rshortLong <- function(xStart, yStart, headingStart = 45, method = "bezier"){
...
h3r <- function(xStart, yStart, headingStart = 45, method = "bezier"){
  ...
  if (yStart %% 1 == 0.5 & headingStart %in% c(45, 225)) {
    output <- h3rshortLong(xStart = xStart, yStart = yStart, headingStart = headingStart, method = method)
  }
  if (xStart %% 1 == 0.5 & headingStart %in% c(45, 225)) {
    output <- h3rlongShort(xStart = xStart, yStart = yStart, headingStart = headingStart, method = method)
  }
